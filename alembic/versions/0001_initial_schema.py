...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("es_apertura", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("delta", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("es_relevante", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("confirmado", sa.Boolean(), nullable=False, server_default=sa.text("true")),
        sa.Column("creado_en", sa.DateTime(timezone=True), nullable=False),
        sa.Column("actualizado_en", sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
